...
public class StudentAccountCourseFullPaymentTableRow extends StudentAccountTableRow
{
	...
	public StudentAccountCourseFullPaymentTableRow()
	{
		System.out.println("AgentAccountCourseInstalmentsTableRow default constructor");
	}
	
	public StudentAccountCourseFullPaymentTableRow(WebElement tableRow)
	{
		//super(driver);
	...
	public void findElements()
	{
		...
		paymentStatus = paymentStatusElement.getText().trim().toLowerCase();
		...
		additionalFeeName = additionalFeeNameElement.getText().trim();
		
		additionalFeeElement = orderTableRow.findElement(additionalFeeLocator);
		additionalFee = additionalFeeElement.getText().trim();
		
		additionalFeeTotalElement = orderTableRow.findElement(additionalFeeTotalLocator);
		additionalFeeTotal = additionalFeeTotalElement.getText().trim();
	}
