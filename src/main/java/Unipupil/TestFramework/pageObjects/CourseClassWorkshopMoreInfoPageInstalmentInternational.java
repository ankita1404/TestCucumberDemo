...
public class CourseClassWorkshopMoreInfoPageInstalmentInternational extends UnipupilWebPage
{
	...
	public CourseClassWorkshopMoreInfoPageInstalmentInternational()
	{
		System.out.println("CourseClassWorkshopMoreInfoPageInstalmentDomestic default constructor");
	}
	
	public CourseClassWorkshopMoreInfoPageInstalmentInternational(WebDriver driver)
	{
		super(driver);
