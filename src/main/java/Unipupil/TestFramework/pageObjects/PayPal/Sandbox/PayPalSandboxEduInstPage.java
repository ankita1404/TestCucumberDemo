...
public class PayPalSandboxEduInstPage extends PayPalSandboxPage
{
	...
	By grossFeeTransactionLocator = By.cssSelector("ul.transactionList.js_transactionList > li:nth-of-type(3)");
	...
	By institutionCommissionLocator = By.cssSelector("ul.transactionList.js_transactionList > li:nth-of-type(2) > div >"
			                        + " div > div:nth-of-type(2) > div > span:nth-of-type(3)");
	By agentCommissionLocator = By.cssSelector("ul.transactionList.js_transactionList > li:nth-of-type(1) > div >"
			                  + " div > div:nth-of-type(2) > div > span:nth-of-type(3)");
	...
	public PayPalSandboxEduInstPage()
	{
		System.out.println("PayPalLiveEduInstPage default constructor");
	}
	
	public PayPalSandboxEduInstPage(WebDriver driver)
	{
		super(driver);
	...
	public BigDecimal getGrossFee()
	{
		...
		//grossFeeElement = amountElements.get(2);
		grossFeeTransactionElement.click();
		grossFeeElement = wait.until(ExpectedConditions.visibilityOfElementLocated(grossFeeLocator));
	...
	{
		//agentCommissionElement = amountElements.get(0);
		agentCommissionElement = wait.until(ExpectedConditions.presenceOfElementLocated(agentCommissionLocator));
		agentCommission = getAmount(agentCommissionElement);
